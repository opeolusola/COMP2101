...
getLANhostname=$(getent hosts $LANaddress|awk '{print $2}')
getexternalIP=$(curl -s icanhazip.com)
getexternalIPname=$(getent hosts $getexternalIP | awk '{print $2}')
...
LAN Hostname    : $getLANhostname
External IP     : $getexternalIP
External Name   : $getexternalIPname
EOF
